-- V040_AddDefaultVariantIdToCatalogueProcs.sql
-- Author: Tesco Clone
-- Date: 2026-05-15
-- Description: Add DefaultVariantId to proc_Catalogue_GetProductById and proc_Catalogue_SearchProducts
--              so the cart handler can use a valid m.tblProductVariant.Id instead of m.tblProduct.Id.
-- Dependencies: V038
...
ALTER PROCEDURE proc_Catalogue_GetProductById
    @ProductId INT
AS
BEGIN
    SET NOCOUNT ON;
...
ALTER PROCEDURE proc_Catalogue_SearchProducts
...
IF NOT EXISTS (SELECT 1 FROM t.tblMigration WHERE Version = 'V040')
    INSERT INTO t.tblMigration (Version, Description) VALUES ('V040', 'AddDefaultVariantIdToCatalogueProcs');
GO
