-- V059_UpdateDashboardStatsAddTotalRevenueAndOrderedCustomers.sql
-- Author: Tesco Clone
-- Date: 2026-05-16
-- Description: Add TotalRevenue (all-time) and TotalOrderedCustomers to proc_Analytics_GetDashboardStats
-- Dependencies: V045
...
BEGIN TRY
    ...
    IF NOT EXISTS (SELECT 1 FROM t.tblMigration WHERE Version = 'V059')
        ...
        VALUES ('V059', 'UpdateDashboardStatsAddTotalRevenueAndOrderedCustomers');
    COMMIT TRANSACTION;
END TRY
BEGIN CATCH
    IF @@TRANCOUNT > 0 ROLLBACK TRANSACTION;
