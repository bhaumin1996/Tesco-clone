-- V088_FixDefaultVariantIdSelection.sql
-- Author: Tesco Clone
-- Date: 2026-05-18
-- Description: Re-create catalogue stored procedures to select in-stock variants as the default variant if available, preventing out-of-stock cart errors for products with multiple variants.
-- Dependencies: V083
...
BEGIN TRY
    ...
    IF NOT EXISTS (SELECT 1 FROM t.tblMigration WHERE Version = 'V088')
        ...
        VALUES ('V088', 'FixDefaultVariantIdSelection');
    COMMIT TRANSACTION;
END TRY
BEGIN CATCH
