-- V048_UpdateAdminGetUsersToIncludeRoles.sql
-- Author: Tesco Clone
-- Date: 2026-05-15
-- Description: Update proc_Admin_GetUsers to include roles for each user using STRING_AGG.
...
IF NOT EXISTS (SELECT 1 FROM t.tblMigration WHERE Version = 'V048')
    INSERT INTO t.tblMigration (Version, Description) VALUES ('V048', 'UpdateAdminGetUsersToIncludeRoles');
GO
