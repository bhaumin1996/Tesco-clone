-- V039_FixQuotedIdentifierOnCartProcedures.sql
-- Author: Tesco Clone
-- Date: 2026-05-15
-- Description: Fix QUOTED_IDENTIFIER setting for cart stored procedures to support filtered indexes
...
IF OBJECT_ID('proc_Order_UpsertCartItem', 'P') IS NOT NULL
    DROP PROCEDURE proc_Order_UpsertCartItem;
GO
...
IF OBJECT_ID('proc_Order_RemoveCartItem', 'P') IS NOT NULL
    DROP PROCEDURE proc_Order_RemoveCartItem;
GO
...
IF OBJECT_ID('proc_Order_ClearCart', 'P') IS NOT NULL
    DROP PROCEDURE proc_Order_ClearCart;
GO
...
IF NOT EXISTS (SELECT 1 FROM t.tblMigration WHERE Version = 'V039')
    INSERT INTO t.tblMigration (Version, Description) VALUES ('V039', 'FixQuotedIdentifierOnCartProcedures');
GO
