-- V038_UpdateCatalogueStoredProceduresFixes.sql
-- Author: Tesco Clone
-- Date: 2026-05-15
-- Description: Update proc_Catalogue_SearchProducts and proc_Catalogue_GetProductById to include IsInStock and Rating columns
-- Dependencies: V036, V037
...
IF NOT EXISTS (SELECT 1 FROM t.tblMigration WHERE Version = 'V038')
    INSERT INTO t.tblMigration (Version, Description) VALUES ('V038', 'UpdateCatalogueStoredProceduresFixes');
GO
